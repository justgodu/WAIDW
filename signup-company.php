...
?>
    ...
    <div>
        <section class="sign-up-section">
            ...
            ?>
            <form class="form-sign-up" action="includes/singup-company.inc.php" method="post">
                <input type="text" name="uid" placeholder="Company Name">
                <input type="text" name="mail" placeholder="Company E-mail">
